...
But a few weeks ago, I did something that went entirely against my programming. I applied for a passport, booked a flight, and crossed the Italian border for the first time in my life. 

Destination: **Nuremberg, Germany**. And honestly? It was terrifying (；⌣_⌣)

## The Weight of the Departure (｡•́︿•̀｡)
...
```
+------------------------------------------------------+
| [!] System Warning: Comfort Zone Exceeded            |
+------------------------------------------------------+
|  Status: Out of Bounds                               |
|  Anxiety Level: High                                 |
|  Current Location: Departing Bari (BRI)              |
+------------------------------------------------------+
```
...
Now, I am back in Bari. I'm sitting at my desk, typing this post on the mechanical keyboard I missed so much. The hum of the PC is here, the monitors are glowing, and everything is exactly where I left it.
